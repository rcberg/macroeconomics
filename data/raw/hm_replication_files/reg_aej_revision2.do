...
u ~/projects/chang/data/merged/data3
...
g hhh1 = log( P_Pbar66 ) - log( P_Pbar64)
...
g www_ap1 = ( share_ap1966 + share_ap1964)/2
...
g growth_model = www*(ddd - hhh)
g growth_naive = www_ap*(ddd - (alpha*hhh) )
g welfare_model = growth_model - www*qqq
