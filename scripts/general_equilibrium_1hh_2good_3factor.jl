...
# println("good X revenue = $(solution[idx_u.x])") # i needed this when i didn't have the zpcs nailed-down
println("good Y profit = $profit_y") # firm Y zero-profit condition
# println("good Y revenue = $( solution[idx_u.p]*solution[idx_u.y] )") # i needed this when i didn't have the zpcs nailed-down
# println("total industry revenue = $( solution[idx_u.x] + solution[idx_u.p]*solution[idx_u.y])") # i needed this when i didn't have the zpcs nailed-down
